                        ...
                        <div class="col-xs-12 col-md-6">
                            <div class="panel panel-body text-center" style="height: 70px;">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <a href="#" class="delete-pages btn btn-sm btn-danger" data-id=""><i class="waves-effect icon icon-list" data-type="cancel"></i></a> |   
                                    <a href="" class="op-link btn btn-sm btn-primary"><i class="icon icon-random"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-md-6">
