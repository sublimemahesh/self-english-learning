            ...
            <ul class="sidenav level-1">
                ...
                <li class="sidenav-item has-subnav open active"> 
                    ...
                    <ul class="sidenav level-2 collapse" aria-expanded="true"> 
                        <li class="list-group-item active"><a href="lesson-home-listning.php">Beginner A1 listening<span class="icon1 icon-unlock-alt" style="color: #f7a033;"></span></a></li>
                ...
                <li class="sidenav-item has-subnav"> 
                    ...
                    <ul class="sidenav level-2 collapse" aria-expanded="false" style="height: 0px;"> 
                        <li class="list-group-item"><a href="lesson-home-speaking.php">Beginner A1 speaking<span class="icon1 icon-unlock-alt"></span></a></li>
                ...
                <li class="sidenav-item has-subnav">
                    ...
                    <ul class="sidenav level-2 collapse" aria-expanded="false" style="height: 0px;"> 
                        <li class="list-group-item"><a href="lesson-home-grammer.php">Adverbs of frequency<span class="icon1 icon-unlock-alt"></span></a></li>
                        <li class="list-group-item"><a href="#">Comparative and superlative<span class="icon1 icon-lock"></span></a></li>
