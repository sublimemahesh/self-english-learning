...
function(a) {
    ...
    function b(b, c) {
        var e = a(b),
            f = e.data("bs.chart"),
            g = e.get(0).getContext("2d");
        if (f) return f;
        var h = {};
        h.type = c.type || c.chart, h.type = a.camelCase(h.type), d(h, "data.labels", c.labels), d(h, "data.datasets", a.map(c.values, function(b) {
            if (b.colorStop1 && b.colorStop2) {
                var d = b.y0,
                    e = b.y1,
                    f = g.createLinearGradient(0, d, 0, e);
                f.addColorStop(0, b.colorStop1), f.addColorStop(1, b.colorStop2), b.backgroundColor = f, b.hoverBackgroundColor = f, delete b.colorStop1, delete b.colorStop2, delete b.y0, delete b.y1
            }
            return ~a.inArray("points", c.hide) && (b.pointBackgroundColor = "transparent", b.pointBorderColor = "transparent"), b
        })), d(h, "options", c), d(h, "paths", {
            ...
            h.paths[b] && h.paths[b].length && d(h.options, h.paths[b], !1)
        }), f = new Chart(g, h), e.data("bs.chart", f)
    }
...
function(a) {
    ...
    function b(b, d) {
        var e = a(b),
            f = e.data("bs.slider");
        if (f) return f;
        d = a.extend({}, c, d), a.isNumeric(d.start) && (d.start = [d.start]), a.isEmptyObject(d.range) && (d.range = {
            max: d.max,
            min: d.min
        }), e.addClass([d.cssPrefix.replace(/-$/, ""), d.cssPrefix.concat(d.slider)].join(" ")), f = noUiSlider.create(b, d), e.data("bs.slider", f)
    }
    var c = {
        connect: "lower",
        cssPrefix: "slider-",
    ...
    a.validator.setDefaults({
        ...
        highlight: function(b, c, d) {
            ...
            if (f.hasClass("has-feedback")) {
                f.find(".form-control-feedback").children().addClass(e.errorIcon).removeClass(e.validIcon)
            }
        ...
        unhighlight: function(b, c, d) {
            var e = a.extend({}, this.settings),
                f = a(b).closest(".form-group");
            if (f.hasClass("has-feedback")) {
                f.find(".form-control-feedback").children().addClass(e.validIcon).removeClass(e.errorIcon)
            }
