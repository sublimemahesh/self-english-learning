...
<html lang="en">
    ...
    <!-- Mirrored from demo.madebytilde.com/elephant-v1.4.0/theme-5/signup-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 02 Jul 2019 07:44:58 GMT -->
    <head>
        <meta charset="UTF-8">
        ...
        <link rel="stylesheet" href="css/signup-1.min.css">
    </head>
    <body>
        <div class="signup">
            ...
            <div class="signup-footer">
                <ul class="list-inline">
                    <li><a class="link-muted" href="login-1.html">Log in</a></li>
                    <li>|</li>
